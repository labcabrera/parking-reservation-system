...
module "keycloak" {
  ...
  parking_client_secret                    = var.parking_client_secret
  parking_client_valid_redirect_uris       = var.parking_client_valid_redirect_uris
  parking_client_web_origins               = var.parking_client_web_origins
  parking_client_front_valid_redirect_uris = var.parking_client_front_valid_redirect_uris
  parking_client_front_web_origins         = var.parking_client_front_web_origins
