...
public record ParkingCapacity(
    ...
    @Min(1)
    @Schema(description = "Total number of parking spots", examples = "120", minimum = "1")
    int total,

    @Min(0)
    @Schema(description = "Parking spots dedicated to short-duration reservations", examples = "80", minimum = "0")
    int shortTerm,

    @Min(0)
    @Schema(description = "Parking spots dedicated to long-duration reservations", examples = "40", minimum = "0")
    int longTerm) {
