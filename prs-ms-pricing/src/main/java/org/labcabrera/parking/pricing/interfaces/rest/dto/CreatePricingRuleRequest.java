...
@Schema(name = "CreatePricingRuleRequest", description = "Request to create a pricing rule configuration")
public record CreatePricingRuleRequest(
    ...
    @DecimalMin("0.0000") @DecimalMax("1.0000") @Digits(integer = 1, fraction = 4) BigDecimal taxRate,
